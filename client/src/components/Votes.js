...
function Votes(props) {
  ...
  return (
    <div
      className={
        textColor === true
          ? "votes-wrapper light-color-text"
          : "votes-wrapper dark-color-text"
      }>
      <div className="votes-thumb">
        <span
          className={
            textColor === true
              ? "votes-number light-color-text"
              : "votes-number dark-color-text"
          }>
          {data.upvotes}
        </span>
        &nbsp;
        <Up onClick={props.handleClickUp} />
      </div>
      <div className="votes-thumb">
        <span
          className={
        ...
        &nbsp;
        <Down onClick={props.handleClickDown} />
      </div>
    </div>
  );
}
